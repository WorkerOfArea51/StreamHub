...
-keep class com.streamhub.app.data.telegram.TelegramUser { *; }
-keep class com.streamhub.app.data.telegram.TelegramAuthState { *; }
-keep class com.streamhub.app.data.telegram.TelegramAuthState$* { *; }
-keep class com.streamhub.app.data.telegram.TdLibAuthState { *; }
-keep class com.streamhub.app.data.telegram.TdLibAuthState$* { *; }
-keep class com.streamhub.app.data.telegram.TelegramStreamResult { *; }
-keep class com.streamhub.app.data.telegram.TelegramStreamResult$* { *; }
-keep class com.streamhub.app.ui.theme.AppThemeAccent { *; }

# --- TDLib (org.drinkless.tdlib) ---
# TDLib uses JNI heavily — all TdApi classes must be preserved
